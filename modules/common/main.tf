...
module "gcs" {
  ...
  source = "./modules/vendor/${each.key}/gcs"
...
module "bigquery" {
  ...
  source = "./modules/vendor/${each.key}/bigquery"
...
module "cloud_function" {
  ...
  source = "./modules/vendor/${each.key}/cloud_function"
...
module "pubsub" {
  ...
  source = "./modules/vendor/${each.key}/pubsub"
